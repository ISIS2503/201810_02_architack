...
public class AppMQTT {
    ...
    public void messageArrived(String topic, String message) throws Exception {
        ...
        if (message.trim().equalsIgnoreCase("11111")) {
            ...
            tipo = 5;
            mens = "Detección de humo en el ambiente fuera de lo normal";
        } else if (message.trim().equalsIgnoreCase("66666")) {
            tipo = 6;
            mens = "Detección de monoxido de carbono en el ambiente fuera de lo normal";
            ...
            tipo = 8;
            mens = "Hub fuera de liena";
        } else if (message.trim().equalsIgnoreCase("99999")) {
            tipo = 9;
            mens = "Cerradura fuera de linea";
        } else {
            tipo = 3;
